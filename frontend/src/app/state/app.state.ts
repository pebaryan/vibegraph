...
export class AppState {
  ...
  get history(): string[] { return this.historySubject.value; }
  get lastResult(): any { return this.resultSubject.value; }
  ...
  setLastResult(res: any) { this.resultSubject.next(res); }
}
